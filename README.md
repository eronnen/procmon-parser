...
For the raw binary format of PMC files you can refer to the [docs](docs/PMC Format.md), or take a look at the source code in [configuration_format.py](procmon_parser/configuration_format.py).
...
For the raw binary format of PML files you can refer to the [docs](docs/PML Format.md), or take a look at the source code in [logs_details_format.py](procmon_parser/logs_details_format.py).
